def generate_bash(name,nfft,batch_size,out_channels, kernel_size_cnn, stride_size_cnn, kernel_size_pool,stride_size_pool):
    commands = []
...
if __name__ == '__main__':
    ...
    generate_bash(name,nfft,batch_size,out_channels, kernel_size_cnn, stride_size_cnn, kernel_size_pool,stride_size_pool)
    print("Success")
