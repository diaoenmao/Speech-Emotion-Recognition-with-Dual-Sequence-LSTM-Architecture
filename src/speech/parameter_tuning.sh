...
CUDA_VISIBLE_DEVICES="0" python full_train_and_test.py -dr 0.2 -b 256 -lr 0.001 -e 50 -bi -hd 250
CUDA_VISIBLE_DEVICES="1" python full_train_and_test.py -dr 0.2 -b 256 -lr 0.001 -e 50 -bi -hd 250
