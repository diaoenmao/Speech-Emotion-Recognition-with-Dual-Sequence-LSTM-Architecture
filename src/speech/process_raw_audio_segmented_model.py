...
class IEMOCAP(Dataset):
    def __init__(self, train=True):
        pickle_in = ''
        if train:
            pickle_in = open('/scratch/speech/raw_audio_dataset/raw_audio_segmented_train.pkl', 'rb')
        else:
            pickle_in = open('/scratch/speech/raw_audio_dataset/raw_audio_segmented_test.pkl', 'rb')
