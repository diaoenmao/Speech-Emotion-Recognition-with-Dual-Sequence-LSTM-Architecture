...
train_loader = DataLoader(dataset=training_data, batch_size=140, shuffle=True, collate_fn=my_collate, num_workers=0)
testing_data = IEMOCAP(train=False)
test_loader = DataLoader(dataset=testing_data, batch_size=140, shuffle=True, collate_fn=my_collate, num_workers=0)
