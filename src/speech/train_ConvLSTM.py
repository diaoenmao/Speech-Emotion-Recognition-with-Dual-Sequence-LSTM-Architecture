...
train_loader = DataLoader(dataset=training_data, batch_size=100, shuffle=True, collate_fn=my_collate(mike=True), num_workers=0)
testing_data = IEMOCAP(train=False, mike=True)
test_loader = DataLoader(dataset=testing_data, batch_size=100, shuffle=True, collate_fn=my_collate(mike=True), num_workers=0)
print("=================")
