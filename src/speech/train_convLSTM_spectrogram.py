...
kernel_size=[9,5,5]
step=10
model = ConvLSTM(3, hidden_channels,kernel_size,step,True)
...
train_loader = DataLoader(dataset=training_data, batch_size=200, shuffle=True, collate_fn=my_collate, num_workers=0, drop_last=True)
