...
model = RawAudioModel(1, 64, 3, 1, 1, 4, 4, 200, 2, 0, 4, 64)
model.cuda()
model.train()
...
train_loader = DataLoader(dataset=training_data, batch_size=64, shuffle=True, collate_fn=my_collate, num_workers=0)
