...
model = SpectrogramModel(3, 64, 3, 1, 1, 4, 4, 200, 2, 0.2, 4, 160, True)
...
train_loader = DataLoader(dataset=training_data, batch_size=160, shuffle=True, collate_fn=my_collate, num_workers=0)
testing_data = IEMOCAP(train=False)
test_loader = DataLoader(dataset=testing_data, batch_size=160, shuffle=True, collate_fn=my_collate, num_workers=0)
